...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const result = await redeemRecovery(token, billing ? billingRecoveryStore : recoveryStore, async (email) => billing || await isPro(email) || await refreshMonthlyPro(email));
