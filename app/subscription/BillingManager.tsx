...
export default function BillingManager() {
  ...
  return <div className="mt-5 space-y-4">
    ...
    <section id="refund" className="scroll-mt-24 border-t border-line pt-6">
      ...
      {state === "ready" ? <RefundManager onSessionExpired={() => { setState("verify"); setConfirm(null); setError("Your secure session expired. Verify your purchase email again to continue. No new refund request was submitted by this action."); }} onSubmitted={() => { void load(); }} /> : <div><p className="text-sm text-muted">Confirm your purchase email to see the payment amount, eligibility, and refund button.</p><ButtonLink href="#cancel" variant="secondary" className="mt-3">Confirm purchase email</ButtonLink></div>}
    </section>
  </div>;
}
